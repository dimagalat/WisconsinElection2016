...
## I cannot confirm that voting machine presence is linked to voting patterns
One interesting dataset provided by the Wisconsin Election Commission is the presence of voting machines on a ward-by-ward basis. I made the assumption that any manipulation of the election results would be more likely to occur in wards / counties that have a higher proportion of voting machines. I have incorporated this information into the data.
