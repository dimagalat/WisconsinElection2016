...
I would like it if someone could explain these results to me! Maybe I am missing something? I have checked the model diagnostics, and I think they are good...
...
I did not see a clear link between the presence of optical scanner presence and party vote at the county level in 2016. However, I did see a *potential' link between the other vote and the presence of optical scanner presence. I still think it is worth investigating 'Other' candidate voting trends from 2000 - 2016 and the link to optical scanner presence, in case there are unusual divergences. When/if more 2016 voting data becomes available, I can investigate this further.
...
```
It is quite clear from the model that the use of 'paper or no paper' voting and the presence of scanner machines does not have an effect on turnout.
